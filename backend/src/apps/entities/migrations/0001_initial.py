    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(db_column='user_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_coupon_transation', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='PARTNER_COMPANY_ID', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='partner_company', to='entities.partnercompany'),
        ),
        migrations.CreateModel(
            name='PostBlog',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='entities.postblog')),
            ],
            options={
